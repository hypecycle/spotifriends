...
def build_genre_db(auth_header):
    ...
    for genre in response:
        ...
        logging.info("artistparser: query for {} started".format(genre))
        ...
        logging.info("artistparser: query for {} returned {} subgenres".format(genre, len(subgenres)))
    ...
    logging.info("artistparser: {} supergenres saved to tb".format(len(supergenres)))
